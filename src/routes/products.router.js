...
import { productErrorIncompleteValues, productErrorInvalidTypes, productAlreadyExistError, internalServerError } from '../constants/products.Errors.js'
...
router.post('/mockingproducts', (req, res) => {
  ...
  try {
    ...
    ErrorService.createError({
      ...
      message: "Se ha producido un error interno en el servidor, por favor, infórmelo e intente su petición más tarde.",
